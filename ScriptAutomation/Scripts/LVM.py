...
class LVM():
    def __init__(self, size=0, disk_name="", source_name="", mount_folder="", increase_size=0, decrease_size=0,
                 hd_name=""):
        self.__size = size
...
def start():
    l = LVM()
    while True:
        print(random.choice(colors) + "               !!!!!LVM Menu!!!!!            \n"  + random.choice(colors) + "Select What do you want....." + random.choice(
            colors) + "\n1.Show all Partitions\n" + random.choice(
            colors) + "2.Create Physical Partition\n" + random.choice(
            colors) + "3.Create Visual Partition\n" + random.choice(
            colors) + "4.Create LVM Partition\n" + random.choice(
            colors) + "5.Increase Partition Size\n" + random.choice(
            colors) + "6.Decrease Partition Size\n" + random.choice(colors) + "7.Show LVM Partition\n" + random.choice(
