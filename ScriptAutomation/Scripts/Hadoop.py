...
class Hadoop():
    ...
    def MasterNode(self):
        ...
        contents = ["<configuration>", "<property>", "<name>dfs.name.dir</name>", value, "</property>",
                    "</configuration>"]
...
def start():
    ...
    choice = -1
    while True:
        choice = int(input(random.choice(colors) + "               !!!!!Hadoop Menu!!!!!            \n"  +
            random.choice(colors) + "Enter what do you want " + random.choice(colors) +  "\n1.Install Hadoop in your System\n" + random.choice(colors) + "2.Setup Name Node\n" + random.choice(colors) + "3.Setup Data Node\n" + random.choice(colors) + "4.Setup Client\n" + random.choice(colors) +  "5.Showing Node Report\n" + random.choice(colors) + "6.Performing Client Operations\n" + random.choice(colors) + "7.Exit\n" + random.choice(colors) + "Enter Choice ...." + random.choice(colors)))
        if choice == 1:
